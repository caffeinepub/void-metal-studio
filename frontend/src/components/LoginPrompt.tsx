...
export default function LoginPrompt() {
  ...
  return (
    <div
      ...
      style={{
        background: 'radial-gradient(ellipse at 50% 30%, oklch(0.12 0.02 25) 0%, oklch(0.06 0.005 20) 70%)',
      }}
    >
      ...
      <div
        className="absolute inset-0 pointer-events-none"
        style={{
          background: 'linear-gradient(180deg, transparent 0%, oklch(0.06 0.005 20 / 0.7) 60%, oklch(0.06 0.005 20) 100%)',
        }}
      />
      ...
      <div className="relative z-10 flex flex-col items-center max-w-lg mx-auto px-6 text-center">
        ...
        <div className="flex gap-4 mt-8 opacity-40">
          {['emoji-skull', 'emoji-raw-heart', 'emoji-blade', 'emoji-void', 'emoji-steel'].map((e) => (
            <img
              key={e}
