...
export default function BanOverlay() {
  return (
    <div
      ...
      style={{ background: 'radial-gradient(ellipse at center, oklch(0.15 0.05 25) 0%, oklch(0.05 0.01 20) 60%, oklch(0 0 0) 100%)' }}
    >
      {/* Dragon eye glow */}
      ...
      <div className="max-w-2xl mx-auto px-8 text-center">
        <h1
          ...
          style={{
            ...
            textShadow: '0 0 30px oklch(0.55 0.25 25 / 0.9), 0 0 60px oklch(0.45 0.2 25 / 0.5)',
          }}
        >
        ...
        >
          ...
          >
            The Dragon caught you stealing. Account permanently removed. Created by Skulls for the people who wanna stay real.
          </p>
        </div>

        <div className="flex justify-center gap-4">
          <img src="/assets/generated/emoji-chain-link.dim_128x128.png" alt="" className="w-10 h-10 opacity-60" />
          <img src="/assets/generated/emoji-void.dim_128x128.png" alt="" className="w-10 h-10 opacity-60" />
          <img src="/assets/generated/emoji-chain-link.dim_128x128.png" alt="" className="w-10 h-10 opacity-60" />
        </div>
      </div>
    </div>
