...
const MODAL_CONFIG = {
  ...
  video: {
    ...
    placeholder: 'Describe your vision... gargoyle rising from stone, fire erupting...',
    icon: 'emoji-watching',
    submitLabel: 'GENERATE VIDEO',
  },
  ignite: {
    title: 'IGNITE SEED',
    placeholder: 'Enter your creation seed... the raw energy that drives the void...',
    icon: 'emoji-ember',
    submitLabel: 'IGNITE',
  },
};
  ...
  return (
    ...
    >
      <div
        ...
        style={{ borderColor: 'oklch(0.45 0.22 25)', boxShadow: '0 0 40px oklch(0.45 0.22 25 / 0.3)' }}
      >
        {/* Header */}
