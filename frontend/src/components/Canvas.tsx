...
function getFileType(file: File): CanvasFile['type'] {
  ...
  if (file.type === 'text/plain' || file.name.endsWith('.txt') || file.name.endsWith('.lrc')) return 'text';
  return 'other';
}
  ...
  return (
    <div className="waveform-container w-full">
      ...
      <audio
        ...
        style={{ height: '32px', filter: 'invert(1) hue-rotate(180deg) saturate(0.5)' }}
...
export default function Canvas({
  ...
  return (
    ...
    >
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
          <div className="mb-4 animate-crack-glow">
            <img
              ...
              style={{ filter: 'drop-shadow(0 0 12px oklch(0.55 0.25 25 / 0.5))' }}
            />
          </div>
          <h3
      ...
      {/* Content area */}
      {hasContent && (
        <div className={`relative z-10 p-4 grid grid-cols-1 md:grid-cols-2 gap-4 ${effectClass}`}>
          {/* Uploaded files */}
          {files.map((cf) => (
            <div
              key={cf.id}
            ...
            >
              <div
                ...
                style={{ color: 'oklch(0.55 0.15 30)', letterSpacing: '0.06em' }}
              >
                {cf.file.name}
              </div>
              ...
              {cf.type === 'other' && (
                ...
                >
                  <img src="/assets/generated/emoji-stone.dim_128x128.png" alt="" className="w-8 h-8" />
                  <span className="font-cinzel text-xs">{cf.file.type || 'Unknown type'}</span>
                </div>
              )}
            </div>
          ))}
          ...
          {generatedResults.map((result) => (
            ...
            >
              <div
                ...
                style={{ color: 'oklch(0.65 0.22 25)', letterSpacing: '0.06em' }}
              >
                <img
              ...
              {result.url && (result.type === 'music' || result.type === 'ignite') && (
