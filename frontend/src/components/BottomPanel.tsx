...
export default function BottomPanel({
  ...
  const getStatusColor = () => {
    ...
    if (statusText.includes('COMPLETE') || statusText.includes('EXPORT')) return 'oklch(0.65 0.2 140)';
    if (statusText.includes('GENERATING') || statusText.includes('IGNITING')) return 'oklch(0.65 0.22 42)';
        ...
        <div className="flex-shrink-0">
          ...
          >
            ...
            <span
              ...
              style={{
                background: 'radial-gradient(ellipse at 50% 100%, oklch(0.55 0.22 40 / 0.15) 0%, transparent 70%)',
              }}
            />
              ...
              {isGenerating ? (
                ...
                <>
                  <img
                    ...
                    style={{ filter: 'drop-shadow(0 0 6px oklch(0.65 0.28 42))' }}
                  />
                  IGNITE
                </>
              )}
